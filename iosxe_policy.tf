  ...
  class_maps = flatten([
    for device in local.devices : [
      for class_map in try(local.device_config[device.name].policy.class_maps, []) : {
        ...
        device                                  = device.name
        name                                    = try(class_map.name, local.defaults.iosxe.configuration.policy.class_maps.name, null)
  ...
  policy_maps = flatten([
    for device in local.devices : [
      for policy_map in try(local.device_config[device.name].policy.policy_maps, []) : {
        ...
        device      = device.name
        name        = try(policy_map.name, local.defaults.iosxe.configuration.policy.policy_maps.name, null)
        ...
        classes = try(length(policy_map.classes) == 0, true) ? null : [for class in policy_map.classes : {
          ...
          actions = try(length(class.actions) == 0, true) ? null : [for action in class.actions : {
            ...
            bandwidth_percent                         = try(action.bandwidth_percent, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.bandwidth_percent, null)
            bandwidth_remaining_option                = try(action.bandwidth_remaining_option, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.bandwidth_remaining_option, null)
            bandwidth_remaining_percent               = try(action.bandwidth_remaining_percent, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.bandwidth_remaining_percent, null)
            bandwidth_remaining_ratio                 = try(action.bandwidth_remaining_ratio, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.bandwidth_remaining_ratio, null)
            priority_level                            = try(action.priority_level, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.priority_level, null)
            priority_burst                            = try(action.priority_burst, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.priority_burst, null)
            queue_limit                               = try(action.queue_limit, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.queue_limit, null)
            queue_limit_type                          = try(action.queue_limit_type, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.queue_limit_type, null)
            shape_average_bit_rate                    = try(action.shape_average_bit_rate, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.shape_average_bit_rate, null)
            shape_average_bits_per_interval_excess    = try(action.shape_average_bits_per_interval_excess, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.shape_average_bits_per_interval_excess, null)
            shape_average_bits_per_interval_sustained = try(action.shape_average_bits_per_interval_sustained, local.defaults.iosxe.configuration.policy.policy_maps.classes.actions.shape_average_bits_per_interval_sustained, null)
    ...
    for device in local.devices : [
      for policy_map in try(local.device_config[device.name].policy.policy_maps, []) : [
        for event in try(policy_map.events, []) : {
          ...
          device     = device.name
          name       = try(policy_map.name, local.defaults.iosxe.configuration.policy.policy_maps.name, null)
          event_type = try(event.event_type, local.defaults.iosxe.configuration.policy.policy_maps.events.event_type, null)
          match_type = try(event.match_type, local.defaults.iosxe.configuration.policy.policy_maps.events.match_type, null)
          class_numbers = try(length(event.classes) == 0, true) ? null : [for class in event.classes : {
            number         = try(class.number, local.defaults.iosxe.configuration.policy.policy_maps.events.classes.number, null)
            class          = try(class.class, local.defaults.iosxe.configuration.policy.policy_maps.events.classes.class, null)
            execution_type = try(class.execution_type, local.defaults.iosxe.configuration.policy.policy_maps.events.classes.execution_type, null)
            action_numbers = try(length(class.actions) == 0, true) ? null : [for action in class.actions : {
              number                                            = try(action.number, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.number, null)
              pause_reauthentication                            = try(action.pause_reauthentication, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.pause_reauthentication, null)
              authorize                                         = try(action.authorize, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.authorize, null)
              terminate_config                                  = try(action.terminate_config, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.terminate_config, null)
              activate_service_template_config_service_template = try(action.activate_service_template_config_service_template, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.activate_service_template_config_service_template, null)
              activate_service_template_config_aaa_list         = try(action.activate_service_template_config_aaa_list, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.activate_service_template_config_aaa_list, null)
              activate_service_template_config_precedence       = try(action.activate_service_template_config_precedence, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.activate_service_template_config_precedence, null)
              activate_service_template_config_replace_all      = try(action.activate_service_template_config_replace_all, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.activate_service_template_config_replace_all, null)
              activate_interface_template                       = try(action.activate_interface_template, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.activate_interface_template, null)
              activate_policy_type_control_subscriber           = try(action.activate_policy_type_control_subscriber, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.activate_policy_type_control_subscriber, null)
              deactivate_interface_template                     = try(action.deactivate_interface_template, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.deactivate_interface_template, null)
              deactivate_service_template                       = try(action.deactivate_service_template, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.deactivate_service_template, null)
              deactivate_policy_type_control_subscriber         = try(action.deactivate_policy_type_control_subscriber, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.deactivate_policy_type_control_subscriber, null)
              authenticate_using_method                         = try(action.authenticate_using_method, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.authenticate_using_method, null)
              ...
              restrict                                          = try(action.restrict, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.restrict, null)
              clear_session                                     = try(action.clear_session, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.clear_session, null)
              clear_authenticated_data_hosts_on_port            = try(action.clear_authenticated_data_hosts_on_port, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.clear_authenticated_data_hosts_on_port, null)
              protect                                           = try(action.protect, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.protect, null)
              err_disable                                       = try(action.err_disable, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.err_disable, null)
              resume_reauthentication                           = try(action.resume_reauthentication, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.resume_reauthentication, null)
              authentication_restart                            = try(action.authentication_restart, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.authentication_restart, null)
              set_domain                                        = try(action.set_domain, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.set_domain, null)
              unauthorize                                       = try(action.unauthorize, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.unauthorize, null)
              notify                                            = try(action.notify, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.notify, null)
              set_timer_name                                    = try(action.set_timer_name, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.set_timer_name, null)
              set_timer_value                                   = try(action.set_timer_value, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.set_timer_value, null)
              map_attribute_to_service_table                    = try(action.map_attribute_to_service_table, local.defaults.iosxe.configuration.policy.policy_maps.events.actions.map_attribute_to_service_table, null)
            }]
          }]
        }
      ]
