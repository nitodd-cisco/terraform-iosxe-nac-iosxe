...
resource "iosxe_save_config" "save_config" {
  ...
  depends_on = [
    ...
    iosxe_flow_monitor.flow_monitors,
    iosxe_flow_record.flow_records,
    ...
    iosxe_interface_nve.nves,
    iosxe_license.license,
    iosxe_line.line,
    iosxe_lldp.lldp,
    iosxe_logging.logging,
    iosxe_mdt_subscription.mdt_subscriptions,
    iosxe_msdp.msdp,
    ...
    iosxe_service_template.service_templates,
    ...
    iosxe_static_route.static_routes,
    iosxe_static_route_vrf.static_routes_vrf,
    iosxe_system.system,
    ...
    iosxe_vlan.vlan,
    iosxe_vlan_configuration.vlan_vn_config,
    iosxe_vlan_access_map.vlan_access_maps,
